...
CREATE TABLE `settings` (
  ...
  `plc_ip` varchar(45) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
INSERT INTO `settings` VALUES (0,'oxin_image_grabber','dataset','Times New Roman',8,'Windows','#F5E603','English',2000,1000,0.9,'[50,50]',12,'dataset','weights','D:',55,50,'opc.tcp://127.0.0.1:8081');
