...
--
-- Table structure for table `localiztion_models`
--

DROP TABLE IF EXISTS `localiztion_models`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `localiztion_models` (
...
--
-- Dumping data for table `localiztion_models`
--

LOCK TABLES `localiztion_models` WRITE;
/*!40000 ALTER TABLE `localiztion_models` DISABLE KEYS */;
INSERT INTO `localiztion_models` VALUES (1,'0','(100,100)','0',10,8,0.001,2,0.25,',4,2,',1.5,95,90,2,90,90,90,90,'datsetpath','weightspath','02/03/1401'),(2,'1','(100,100)','0',10,8,0.001,2,0.25,',4,2,',1.5,95,90,2,90,90,90,90,'datsetpath','weightspath','02/03/1401');
/*!40000 ALTER TABLE `localiztion_models` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-08-22 10:00:22
