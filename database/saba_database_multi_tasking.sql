...
DROP TABLE IF EXISTS `multi_tasking`;
...
LOCK TABLES `multi_tasking` WRITE;
/*!40000 ALTER TABLE `multi_tasking` DISABLE KEYS */;
INSERT INTO `multi_tasking` VALUES (0,5,4,24,4,2,8,2,5,100,5,4,24);
/*!40000 ALTER TABLE `multi_tasking` ENABLE KEYS */;
UNLOCK TABLES;
