...
"")
        ...
        self.close_btn.setStyleSheet(u" border-radius: 1px;")
        icon = QIcon()
        ...
        self.tableWidget_dataset = QTableWidget(self.frame)
        if (self.tableWidget_dataset.columnCount() < 3):
            self.tableWidget_dataset.setColumnCount(3)
        ...
        self.tableWidget_dataset.setStyleSheet(u"")
        ...
        self.tableWidget_dataset.setRowCount(1)
        self.tableWidget_dataset.setColumnCount(3)
        self.tableWidget_dataset.horizontalHeader().setMinimumSectionSize(50)
