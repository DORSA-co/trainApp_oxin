...
"color: black;")
        ...
        icon = QIcon()
        icon.addFile(u"images/magnifying-glass.png", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u" Search Bar", None))
