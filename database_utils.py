...
#'Dorsa1400@'
class dataBaseUtils:
    def __init__(self, user_name="root", password="J@min1378"):
    ...
    def set_split_size(self, size, id):
        self.db.update_record(
            table_name=self.datasets_table,
            col_name="split_size",
            value=str(size),
            id="id",
            id_value=id,
    ...
    def get_split_size(self, id):
        record = self.db.search(
            table_name=self.datasets_table, param_name="id", value=id
        )[0]
    ...
    def get_binary_models(
        ...
        try:
            bmodels = self.db.get_all_content(
                type_model,
                count=count,
                limit=limit,
    ...
    def search_binary_model_by_filter(
        ...
        try:
            # print('here')
            record = self.db.search_with_range(
                model_type,
                cols,
                parms,
                limit=limit,
    ...
    def search_cls_model_by_filter(
        ...
        try:
            # print('here')
            record = self.db.search_with_range_with_classes(
                "classification_models",
                cols,
                parms,
                limit=limit,
