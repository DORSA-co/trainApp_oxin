...
class Collector():
    ...
    def __init__(self,serial_number, gain = 0 , exposure = 70000, max_buffer = 20, trigger=True, delay_packet=100, packet_size=1500 , frame_transmission_delay=0 ,width=1000,height=1000,offet_x=0,offset_y=0,manual=False):
    ...
    def get_all_devices(self):
        ...
        return self.all_available_cameras
...
class connect_manage_cameras():
    ...
    def add_camera(self,id,cam_parms):
        ...
        # instant_onj=Collector(cam_parms['serial_number']).get_cam()

        # print(instant_onj.IsGrabbing())
        ...
        # print(cam_parms['serial_number'])
            ...
            try:
                ...
                collector = Collector(str(cam_parms['serial_number']),exposure=cam_parms['expo_value'], gain=cam_parms['gain_value'], trigger=False, delay_packet=cam_parms['interpacket_delay'],\
